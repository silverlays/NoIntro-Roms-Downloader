...
class MainWindow():
  ...
  def _create_window(self):
    frame_layout = [
      ...
      [sg.Listbox([], key="listbox_games", expand_x=True, expand_y=True, enable_events=True, select_mode=sg.LISTBOX_SELECT_MODE_MULTIPLE, font=("", 10, "bold"), text_color="#008040")],
