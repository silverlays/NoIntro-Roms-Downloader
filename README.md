...
## Description
Download "official" roms from NoIntro fullsets on Internet Archive (archive.org). Last binaries available [here](https://github.com/silverlays/NoIntro-Roms-Downloader/releases/latest) or you can just clone the repo and launch it under Windows and Linux. (see below)
